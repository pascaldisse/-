...
- Q11: 腕A=8、腕B=5(sonnet/kimi/flash)。全6枡のA>B(+3〜+4) → **目盛規約効果=確定**。
- Q12: sonnet A=6/B=3、kimi A=8/B=5、flash A=8/B=4 → 規約効果有。
...
- **確定**: N=5・分散報告(成功頭)／規約有無の系統効果(Q11/Q12)／glm死枝=403。
- **争域**: 1召内多run、先行値漏洩、lane独立性。証跡欠に因る。Q2の実裂。
